    ...
    \begin{multicols*}{2}
        ...
        \section{Rotations}
            ...
            \par
                ...
                \end{gather*}
        \section{Duals and complements}
            \par
                For a blade $ X_i $ in a k-vector we can define some operations,
                ...
                \begin{gather*}
                    ...
                    complement(A) = \sum_i complement(X_i) \\
                \end{gather*}
            \par
        ...
        \section{Shapes and sizes}
            ...
            \par
                Then we can start defining operators:
                \begin{gather*}
                ...
                \aside{In other words it's equal to the geometric product if the grades add together:
                ...
                \aside{Since all of these are based of the geometric product they retain distributivity and associativity}
            \par
            ...
            \par
                The wedge product allows you to meet two objects:
                \begin{gather*}
