    ...
    \begin{multicols*}{2}
        ...
        \section{Shapes and sizes}
            ...
            \par
                ...
                \begin{align*}
                    line_1 \meet line_1 = x e_1 + y e_2 + ... + w e_d
                \end{align*}
                \boxedmath{\begin{aligned}
        ...
        \section{Motors}
            ...
            \par
                TODO: applying motors and line forces per https://enki.ws/ganja.js/examples/coffeeshop.html\#sUwbwu9vR and https://bivector.net/PGADYN.html
    \end{multicols*}
\end{document}
