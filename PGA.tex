    ...
    \begin{multicols*}{2}
        ...
        \section{Unary operators}
            ...
            \par
                For example:
                \begin{gather*}
                    \underline{X_i} X_i = \mathbb{1} \texttt{ // left complement} \\ % TODO: left complement is the inverse of right complement!
        ...
        \section{Shapes and sizes}
            ...
            \par
                ...
                $$\begin{aligned}
                    ...
                    A \vee B &= \overdash{\overline{A} \wedge \overline{B}} \texttt{ // antiwedge product} % TODO: this adds antigrades()
                \end{aligned}$$
            ...
            \par
                TODO: something about objects being direction + position \\
                TODO: something about planes being normal + distance \\
                TODO: something about sizes of line segments / volumes
            \subsection{Rasterization}
            \par
                TODO: projection to camera plane + depth buffer
                Projection: $ P = (A \cdot B^{-1}) B $ ? % TODO: define dot and inverse
            \subsection{Raytracing}
                \par
                    TODO: $ line_1 \wedge line_2 = signed\_distance(line_1, line_2) \norm{line_1^{ND} \wedge line_2^{ND}} $ \\
        ...
        \section{Motors}
            ...
            \par
                ...
                \begin{gather*}
                    ...
                    A^{-1} = \F{A}{\norm{A}^2} \\ % TODO: does inverse involve the reverse?
