...
apply \REF{sec:Rules} to break it down into functions of one variable.
...
Come back after reading \REF{sec:Rules}.
\begin{align*}
	\D e^{-x} & = e^{-x} * (-1) \\
	\D e^{-x} & = -e^{-x}       \\
\end{align*}
